...
# Functions to call movie title, storyline, poster image, backdrop image, tagline, and rating (respectively)
...
nightmare_before_christmas = media.Movie(get_title(9479),
                        get_storyline(9479),
                        get_poster_img(9479),
...
movies = [nightmare_before_christmas, hocus_pocus, beetlejuice, practical_magic, corpse_bride, the_craft]
